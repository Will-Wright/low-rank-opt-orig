classdef packSVD
% PACKSVD
%   Constructor for the PACKSVD class
...
%
%   PACKSVD( S, U, V )
%       returns a matrix implicitly formed as X = U*diag(S)*V'
%       U and V are not required to have orthonormal columns
%       (although this is typical)


% Need to document this.
% Example: do we expect U and V, or U' and V' (or U.' and V.') ???
%   (I think we want U and V)
% Also, what is v.orth for?
%   This tells us when we already know X in factored form?
%   But this seems like the opposite of how it's used below:
%       we set v.orth = true when we do *not* know U and V
    ...
    case 1,
        ...
        switch class( X ),
            ...
            otherwise,
                ...
                error( 'Cannot convert class %s to packSVD', class(v) );
